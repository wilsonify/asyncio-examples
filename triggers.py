"""
“Case Study: Cache Invalidation”, one of the required Python source
files was omitted in the interest of saving space. That file is presented below, with annotation.
"""
...
id = NEW.id;data = row_to_json(NEW);
